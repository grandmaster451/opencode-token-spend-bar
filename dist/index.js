...
function SessionSpendWidget(props) {
  ...
  return /* @__PURE__ */ React.createElement("box", { flexDirection: "column" }, lines.map((line) => /* @__PURE__ */ React.createElement("text", null, line)));
}
...
var UsageAggregator = class {
  ...
  async initialize() {
    ...
    const records = scanCurrentMonthHistory();
...
// src/index.tsx
var tui = TokenSpendBarPlugin;
var index_default = TokenSpendBarPlugin;
export {
  TokenSpendBarPlugin,
