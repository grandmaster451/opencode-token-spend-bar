...
import { createElement as createElement2, insert as insert2, setProp as setProp2 } from "@opentui/solid";
...
function SessionSpendWidget(props) {
  ...
  const box = createElement2("box");
  setProp2(box, "flexDirection", "column");
  const heading = createElement2("text");
  insert2(heading, "Token spend");
  insert2(box, heading);
  for (const line of lines) {
    const text = createElement2("text");
    insert2(text, line);
    insert2(box, text);
  }
  return box;
